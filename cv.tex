...
and the Swiss National Science Foundation. I have published over 100 peer-reviewed publications, leading to an h-index of 39 as tracked by Google Scholar.
...
External evaluation of scientific and pedagogical merits and a legal requirement to supervise PhD students in Sweden.}
\sepspace
...
\item{Member of the Faculty Senate Drafting Board}
\end{itemize}
}
\sepspace
...
\begin{itemize}
\item Unit Manager Cyber-Physical Systems (Chalmers and the University of Gothenburg, 01.04.2022 - ongoing)  
...
\begin{itemize}
  ...
  \item IEEE/ACM International Conference on Automated Software Engineering (ASE 2022)
...
\begin{itemize}
  ...
  \item H. Samoaa, F. Bayram, P. Salza, and \textbf{P. Leitner}: \emph{A Systematic Mapping Study of Source Code Representation for Deep Learning in Software Engineering}, IET Software, 2022. To appear.  
  \item L. Erlenhov,  F. Gomes, and \textbf{P. Leitner}: \emph{Dependency management bots in open-source systems - prevalence and adoption}, PeerJ Computer Science, 2021. To appear.  
  \item C. Laaber, \textbf{P. Leitner}, and H. Gall: \emph{Applying Test Case Prioritization to Software Microbenchmarks}, Empirical Software Engineering, 2021. To appear.
  ...
  Relevance of Microbenchmark Suites}, PeerJ Computer Science. To appear.
