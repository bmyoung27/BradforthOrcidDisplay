...
\PersonalEntry{WWW}{\href{http://pleitner.wordpress.com}{http://pleitner.wordpress.com}}
...
\EducationEntry{Assistant Professor}{Since Aug. 14}{Chalmers $|$ University of Gothenburg}{\begin{itemize}
...
\begin{itemize}
\item Publicity Chair of Elsevier's Journal on Systems and Software (JSS). Responsible for Coordinating the publicity efforts of the journal.
...
\begin{itemize}
	\item \textbf{Joel Scheuner}  (Chalmers, PhD student, cloud benchmarking)
\item \textbf{Christoph Laaber} (UZH, PhD student, cost-aware cloud engineering, co-supervised with Harald C. Gall)
\item \textbf{J\"urgen Cito} (UZH, PhD student, cloud performance engineering, co-supervised with Harald C. Gall)
\item \textbf{Gerald Schermann} (UHZ, PhD student, continuous delivery, co-supervised with Harald C. Gall)
\end{itemize}
