...
\begin{itemize}
\item \textbf{Alfred \AAkesson} (Lund University, licenciate discussion leader)
\end{itemize}
...
\begin{itemize}
	\item  Y. Guo and \textbf{Philipp Leitner}: \emph{Studying the impact of CI on pull request delivery time in open source projects — a conceptual replication}, PeerJ Computer Science, 2019. doi: 10.7717/peerj-cs.245.
	\begin{shaded}
	\item D. Costa, CP. Bezemer, \textbf{Philipp Leitner}, and  A. Andrzejak: \emph{What’s Wrong With My Benchmark Results? Studying Bad Practices in JMH Benchmarks}, IEEE Transactions on Software Engineering (TSE), to appear.
	\end{shaded}
	\item  B. Varghese, \textbf{Philipp Leitner}, S. Ray, K. Chard, A. Barker, Y. Elkhatib, H. Herry, C.H. Hong, J. Singer, F.P. Tso, E. Yoneki, and M.F. Zhani: \emph{Cloud Futurology}, IEEE Computer 52(9): 68-77 (2019)
	\begin{shaded}
